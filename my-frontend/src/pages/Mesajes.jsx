                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr className="border-b dark:border-gray-700">
                                        ...
                                        <th scope="col" class="px-4 py-3">sjhesua@gmail.com</th>
                                        <th scope="col" class="px-4 py-3">Jhesua Sifontes</th>
                                        <td className="px-4 py-3 flex items-center justify-end">
                                            <button onClick={toggleDropdown} id="apple-imac-20-dropdown-button" data-dropdown-toggle="apple-imac-20-dropdown" className="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                                <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                                </svg>
                                            </button>
                                            <div id="apple-imac-20-dropdown" className={`${isDropdownOpen ? 'block' : 'hidden'} absolute z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`}>
                                                ...
                                                <div className="py-1" onClick={toggleDropdown}>
                                                    <a href="#" className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Exit</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
